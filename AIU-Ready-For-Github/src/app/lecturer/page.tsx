  ...
  const startSession = async () => {
    ...
    if (useGeofence) {
      ...
      try {
        ...
        alert("Failed to get location. Please enable location permissions or uncheck Geofencing.");
        setLocating(false);
        return;
      }
      setLocating(false);
                ...
                <div style={{ textAlign: "center", padding: "4rem 2rem", background: "rgba(15, 23, 42, 0.4)", borderRadius: "8px" }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1rem" }}>
                    <div className="form-group" style={{ textAlign: "center" }}>
                      <label>Set Custom Timer (Seconds) - Leave 0 for Manual Close</label>
                      <input 
                        type="number"
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "1rem" }}>
                      ...
                      />
                      <label htmlFor="geofence" style={{ cursor: "pointer", color: "white" }}>Require 50-Meter Location Lock 📍</label>
                    </div>
                    
                    <button className="btn btn-primary" onClick={startSession} style={{ maxWidth: "250px" }} disabled={locating}>
                      {locating ? "Acquiring GPS..." : "Start New Session"}
                    </button>
                  </div>
                </div>
              )}
